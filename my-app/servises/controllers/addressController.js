...
const createAddress = async (req, res) => {
    ...
    const user_id = addressinfo.id; // Adjust this based on your authentication mechanism
...
const removeaddress = async (req, res) => {
    ...
    try {
        ...
        const userId = addressinfo.id; // Adjust this based on your authentication mechanism
